   ...
   <div className="min-h-screen flex flex-col">
    <div className="px-6 py-3 flex items-center justify-between border-b">
      ...
      <div className="flex items-center gap-3">
        <span className="text-sm text-muted-foreground">Desenvolvido com 💙 no NLW da Rocketseat por <span className="text-primary">Gabriel Vicente</span></span>
    ...
    <main className="flex-1 p-6 flex gap-6">
      ...
      <aside className="w-80 space-y-6">
        <form className="space-y-6">
          <label
            htmlFor="video"
            className="border flex flex-col gap-2 items-center justify-center rounded-md aspect-video cursor-pointer border-dashed text-sm text-muted-foreground hover:bg-primary/10"
            >
          ...
          <Button type="submit" className="w-full">Carregar vídeo
